...
export default function NewsList() {
  ...
  return <PublicLayout><SeoHead title="Tin tức KCN Xuân Cẩm - Hương Lâm mới nhất" description="Cập nhật tiến độ, quy hoạch, hạ tầng, pháp lý và hoạt động đầu tư mới nhất tại Khu Công nghiệp Xuân Cẩm - Hương Lâm, tỉnh Bắc Ninh." path="/tin-tuc" />
